    ...
    function(query, options, callback) {
        try {
            if (options.watch !== undefined) {
                if (typeof options.watch === 'function') options.watch({
                    operation: 'find',
...
Collection.prototype.findOneAndUpdate = function(filter, update, options, callback) {
    ...
    options = options || {};
    if(options.watch !== undefined){
        if(typeof options.watch === 'function')options.watch({operation:'findOneAndUpdate',collection:this.s.name,query:update})
    }
